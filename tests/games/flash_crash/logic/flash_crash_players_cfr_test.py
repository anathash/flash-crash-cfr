...
class TestFlashCrashPlayers_CFR  (unittest.TestCase):
    ...
    @staticmethod
    def fill_dict(to_move, actions, history_assets_dict, budget, actions_history, inf_set, terminal=False, eval=None):
        return{'to_move':to_move,'actions':actions,'actions_history':actions_history,
    ...
    def gen_tree(self,):
        ...
        root = {'to_move':CHANCE,'actions':['50','30'],  'inf_set':'.', 'terminal':False }
        price_drop_log= "{'a1': '1->0.5'}"
        empty_log = '{}'

        node_1_0 = self.fill_dict(to_move=ATTACKER, actions = sell_actions, history_assets_dict={BUY:{},SELL:{}},
                                  budget=Budget(attacker=50,defender=50), actions_history={BUY:[],SELL:[], SIM_TRADE:[]},inf_set= '.50.A_HISTORY:[]')

        node_1_0_0 = self.fill_dict(to_move=DEFENDER, actions=buy_actions, history_assets_dict={BUY: {}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=50),
                                    actions_history={BUY: [], SELL: [sell], SIM_TRADE: []}, inf_set='.50.D_HISTORY:[]')

        node_1_0_1 = self.fill_dict(to_move=DEFENDER, actions=buy_actions,
        ...
        node_1_0_1_0 = self.fill_dict(to_move=MARKET, actions=[], history_assets_dict={BUY: {'a1':1}, SELL: {}},
                                    budget=Budget(attacker=50, defender=0),
                                    actions_history={BUY: [buy], SELL: [nope], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{'a1': 50}.SELL:{}",terminal=True, eval=0)

        node_1_0_1_1 = self.fill_dict(to_move=MARKET, actions=[], history_assets_dict={BUY: {}, SELL: {}},
                                    budget=Budget(attacker=50, defender=50),
                                    actions_history={BUY: [nope], SELL: [nope], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{}.SELL:{}",terminal=True, eval=0)

        node_1_0_0_0 = self.fill_dict(to_move=MARKET, actions=[empty_log], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
        ...
        node_1_0_0_1 = self.fill_dict(to_move=MARKET, actions=[price_drop_log],
                                      history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                      budget=Budget(attacker=0, defender=50),
                                      actions_history={BUY: [nope], SELL: [sell], SIM_TRADE: []},
                                      inf_set=".MARKET_HISTORY:[].BUY:{}.SELL:{'a1': 50}")

        node_1_0_0_1_0 =  self.fill_dict(to_move=ATTACKER, actions=[], history_assets_dict={BUY: {}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=50),
                                    actions_history={BUY: [nope, price_drop_log], SELL: [sell, price_drop_log], SIM_TRADE: [price_drop_log]},
                                         inf_set=".0.A_HISTORY:['[Sell a1 50]', \"{'a1': '1->0.5'}\"]", terminal=True, eval= -1)

        node_1_0_0_0_0 = self.fill_dict(to_move=ATTACKER, actions=['[]'], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
                                    actions_history={BUY: [buy, empty_log], SELL: [sell, empty_log], SIM_TRADE: [empty_log]}, inf_set=".0.A_HISTORY:['[Sell a1 50]', '{}']")

        node_1_0_0_0_0_0 = self.fill_dict(to_move=DEFENDER, actions=['[]'], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
                                    actions_history={BUY: [buy, empty_log], SELL: [sell, empty_log, nope], SIM_TRADE: [empty_log]}, inf_set=".0.D_HISTORY:['[Buy a1 50]', '{}']")

        node_1_0_0_0_0_0_0 =  self.fill_dict(to_move=MARKET, actions=[], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
        ...
        ###########
        node_1_1 = self.fill_dict(to_move=ATTACKER, actions = [nope] , history_assets_dict={BUY:{},SELL:{}},
                                  budget=Budget(attacker=30,defender=50), actions_history={BUY:[],SELL:[], SIM_TRADE:[]},inf_set= '.30.A_HISTORY:[]')

        node_1_1_0 = self.fill_dict(to_move=DEFENDER, actions=buy_actions,
                                    history_assets_dict={BUY: {}, SELL: {}},
                                    budget=Budget(attacker=30, defender=50),
                                    actions_history={BUY: [], SELL: [nope], SIM_TRADE: []}, inf_set='.50.D_HISTORY:[]')

        node_1_1_0_0 = self.fill_dict(to_move=MARKET, actions=[], history_assets_dict={BUY: {'a1':1}, SELL: {}},
                                    budget=Budget(attacker=30, defender=0),
                                    actions_history={BUY: [buy], SELL: [nope], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{'a1': 50}.SELL:{}",terminal=True, eval=0)

        node_1_1_0_1 = self.fill_dict(to_move=MARKET, actions=[], history_assets_dict={BUY: {}, SELL: {}},
                                    budget=Budget(attacker=30, defender=50),
                                    actions_history={BUY: [nope], SELL: [nope], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{}.SELL:{}",terminal=True, eval=0)
        ...
        node_1_0_1['children'] = {buy:  node_1_0_1_0, nope: node_1_0_1_1}
