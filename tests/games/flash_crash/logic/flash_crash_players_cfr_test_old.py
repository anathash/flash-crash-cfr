...
class TestFlashCrashPlayers_CFR  (unittest.TestCase):
    ...
    def test_tree(self):
        ...
        actual_tree = FlashCrashRootChanceGameState(action_manager, af_network=network, defender_budget=50, attacker_budgets=[50, 30])
    ...
    def gen_tree(self,):
        ...
        buy = str([Buy('a1', 50)])
        nope = str([])
        sell_actions = [nope, sell]
        buy_actions = [nope,buy ]
        root = {'name':'root', 'to_move':CHANCE,'actions':['40','30'],  'inf_set':'.', 'terminal':False }
        price_drop_log= "{'a1': '1->0.6'}"
        price_bump_log = "{'a1': '1->1.5'}"
        price_bump_log_06 = "{'a1': '0.6->1.5'}"
        empty_log = '{}'

        node_1_0 = self.fill_dict(name ='node_1_0', to_move=ATTACKER, actions = sell_actions, history_assets_dict={BUY:{},SELL:{}},
                                  budget=Budget(attacker=50,defender=50), actions_history={BUY:[],SELL:[], SIM_TRADE:[]},inf_set= '.50.A_HISTORY:[]')

        node_1_0_0 = self.fill_dict(name ='node_1_0_0', to_move=DEFENDER, actions=buy_actions, history_assets_dict={BUY: {}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=50),
                                    actions_history={BUY: [], SELL: [sell], SIM_TRADE: []}, inf_set='.50.D_HISTORY:[]')

        node_1_0_1 = self.fill_dict(name ='node_1_0_1', to_move=DEFENDER, actions=buy_actions,
                                    history_assets_dict={BUY: {}, SELL: {}},
                                    budget=Budget(attacker=50, defender=50),
                                    actions_history={BUY: [], SELL: [nope], SIM_TRADE: []}, inf_set='.50.D_HISTORY:[]')

        node_1_0_1_0 = self.fill_dict(name ='node_1_0_1_0',to_move=MARKET, actions=[], history_assets_dict={BUY: {}, SELL: {}},
                                    budget=Budget(attacker=50, defender=50),
                                    actions_history={BUY: [nope], SELL: [nope], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{}.SELL:{}",terminal=True, eval=0)

        node_1_0_1_1 = self.fill_dict(name ='node_1_0_1_1',to_move=MARKET, actions=[price_bump_log],
                                      history_assets_dict={BUY: {'a1':1}, SELL: {}},
                                      budget=Budget(attacker=50, defender=0),
                                      actions_history={BUY: [buy], SELL: [nope], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{'a1': 50}.SELL:{}")

        node_1_0_1_1_0 = self.fill_dict(name='node_1_0_1_1_0', to_move=ATTACKER, actions=['[]'],
                                        history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                        budget=Budget(attacker=0, defender=50),
                                        actions_history={BUY: [nope, price_drop_log], SELL: [sell, price_drop_log],
                                                         SIM_TRADE: [price_drop_log]},
                                        inf_set=".0.A_HISTORY:['[Sell a1 50]', \"{'a1': '1->0.6'}\"]")

        node_1_0_1_1_0_0 = self.fill_dict(name='node_1_0_1_1_0_0', to_move=DEFENDER, actions=buy_actions,
                                          history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                          budget=Budget(attacker=0, defender=50),
                                          actions_history={BUY: [nope, price_drop_log],
                                                           SELL: [sell, price_drop_log, nope],
                                                           SIM_TRADE: [price_drop_log]},
                                          inf_set=".50.D_HISTORY:['[]', \"{'a1': '1->0.6'}\"]")

        node_1_0_1_1_0_0_0 = self.fill_dict(name='node_1_0_1_1_0_0_0', to_move=MARKET, actions=[],
                                            history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                            budget=Budget(attacker=0, defender=50),
                                            actions_history={BUY: [nope, price_drop_log, nope],
                                                             SELL: [sell, price_drop_log, nope],
                                                             SIM_TRADE: [price_drop_log]},
                                            inf_set=".MARKET_HISTORY:[\"{'a1': '1->0.6'}\"].BUY:{}.SELL:{}"
                                            , terminal=True, eval=0)

        node_1_0_0_0 = self.fill_dict(name ='node_1_0_0_0',to_move=MARKET, actions=[empty_log], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
                                    actions_history={BUY: [buy], SELL: [sell], SIM_TRADE: []}, inf_set=".MARKET_HISTORY:[].BUY:{'a1': 50}.SELL:{'a1': 50}")

        node_1_0_0_1 = self.fill_dict(name ='node_1_0_0_1',to_move=MARKET, actions=[price_drop_log],
                                      history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                      budget=Budget(attacker=0, defender=50),
                                      actions_history={BUY: [nope], SELL: [sell], SIM_TRADE: []},
                                      inf_set=".MARKET_HISTORY:[].BUY:{}.SELL:{'a1': 50}")

        node_1_0_0_1_0 =  self.fill_dict(name ='node_1_0_0_1_0',to_move=ATTACKER, actions=['[]'], history_assets_dict={BUY: {}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=50),
                                    actions_history={BUY: [nope, price_drop_log], SELL: [sell, price_drop_log], SIM_TRADE: [price_drop_log]},
                                         inf_set=".0.A_HISTORY:['[Sell a1 50]', \"{'a1': '1->0.6'}\"]")

        node_1_0_0_1_0_0 = self.fill_dict(name ='node_1_0_0_1_0_0',to_move=DEFENDER, actions=buy_actions,
                                          history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                          budget=Budget(attacker=0, defender=50),
                                          actions_history={BUY: [nope, price_drop_log], SELL: [sell, price_drop_log, nope],
                                                          SIM_TRADE: [price_drop_log]},
                                          inf_set=".50.D_HISTORY:['[]', \"{'a1': '1->0.6'}\"]")

        node_1_0_0_1_0_0_0 = self.fill_dict(name ='node_1_0_0_1_0_0_0',to_move=MARKET, actions=[],
                                            history_assets_dict={BUY: {}, SELL: {'a1': 1}},
                                            budget=Budget(attacker=0, defender=50),
                                            actions_history={BUY: [nope, price_drop_log, nope],
                                                             SELL: [sell, price_drop_log, nope],
        ...
        node_1_0_0_1_0_0_1 = self.fill_dict(name ='node_1_0_0_1_0_0_1',to_move=MARKET, actions=[ "{'a1': '0.6->1.5'}"],
                                            history_assets_dict={BUY: {'a1': 1}, SELL: {'a1': 1}},
                                            budget=Budget(attacker=0, defender=20),
                                            actions_history={BUY: [nope, price_drop_log, buy],
                                                             SELL: [sell, price_drop_log, nope],
                                                             SIM_TRADE: [price_drop_log]},
                                            inf_set=".MARKET_HISTORY:[\"{'a1': '1->0.6'}\"].BUY:{'a1': 50}.SELL:{}")

        node_1_0_0_1_0_0_1_0 = self.fill_dict(name='node_1_0_0_1_0_0_1_0', to_move=ATTACKER, actions=['[]'],
                                        history_assets_dict={BUY: {'a1': 1}, SELL: {'a1': 1}},
                                        budget=Budget(attacker=0, defender=20),
                                        actions_history={BUY: [nope, price_drop_log, buy, price_bump_log_06],
                                                               SELL: [sell, price_drop_log, nope, price_bump_log_06],
                                                               SIM_TRADE: [price_drop_log, price_bump_log_06]},
                                        inf_set=".0.A_HISTORY:['[Sell a1 50]', \"{'a1': '1->0.6'}\", '[]', \"{'a1': '0.6->1.5'}\"]")

        node_1_0_0_1_0_0_1_0_0 = self.fill_dict(name='node_1_0_0_1_0_0_1_0_0', to_move=DEFENDER, actions=['[]'],
                                          history_assets_dict={BUY: {'a1': 1}, SELL: {'a1': 1}},
                                          budget=Budget(attacker=0, defender=20),
                                                actions_history={BUY: [nope, price_drop_log, buy, price_bump_log_06],
                                                                 SELL: [sell, price_drop_log, nope, price_bump_log_06, nope],
                                                                 SIM_TRADE: [price_drop_log, price_bump_log_06]},
                                          inf_set=".20.0.D_HISTORY:['[]', \"{'a1': '1->0.6'}\", '[Buy a1 50]', \"{'a1': '0.6->1.5'}\"]")

        node_1_0_0_1_0_0_1_0_0_0 = self.fill_dict(name='node_1_0_0_1_0_0_1_0_0_0', to_move=MARKET, actions=[],
                                            history_assets_dict={BUY: {'a1': 1}, SELL: {'a1': 1}},
                                            budget=Budget(attacker=0, defender=20),
                                            actions_history={BUY: [nope, price_drop_log, buy, price_bump_log_06, nope],
                                                                   SELL: [sell, price_drop_log, nope, price_bump_log_06, nope],
                                                                   SIM_TRADE: [price_drop_log, price_bump_log_06]},
                                            inf_set=".MARKET_HISTORY:[\"{'a1': '1->0.6'}\", \"{'a1': '0.6->1.5'}\"].BUY:{}.SELL:{}", terminal=True, eval=0)

        node_1_0_0_0_0 = self.fill_dict(name ='node_1_0_0_0_0',to_move=ATTACKER, actions=['[]'], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
                                    actions_history={BUY: [buy, empty_log], SELL: [sell, empty_log], SIM_TRADE: [empty_log]}, inf_set=".0.A_HISTORY:['[Sell a1 50]', '{}']")

        node_1_0_0_0_0_0 = self.fill_dict(name ='node_1_0_0_0_0_0',to_move=DEFENDER, actions=['[]'], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
                                    actions_history={BUY: [buy, empty_log], SELL: [sell, empty_log, nope], SIM_TRADE: [empty_log]}, inf_set=".0.D_HISTORY:['[Buy a1 50]', '{}']")

        node_1_0_0_0_0_0_0 =  self.fill_dict(name ='node_1_0_0_0_0_0_0',to_move=MARKET, actions=[], history_assets_dict={BUY: {'a1':1}, SELL: {'a1':1}},
                                    budget=Budget(attacker=0, defender=0),
                                    actions_history={BUY: [buy, empty_log, nope], SELL: [sell, empty_log, nope], SIM_TRADE: [empty_log]},
                                             inf_set=".MARKET_HISTORY:['{}'].BUY:{}.SELL:{}",terminal=True, eval=0)

        ###########
        node_1_1 = self.fill_dict(name ='node_1_1',to_move=ATTACKER, actions = [nope] , history_assets_dict={BUY:{},SELL:{}},
                                  budget=Budget(attacker=30,defender=50), actions_history={BUY:[],SELL:[], SIM_TRADE:[]},inf_set= '.30.A_HISTORY:[]')
        ...
        root['children'] = {'50': node_1_0, '30': node_1_1}
        node_1_0['children'] = {sell: node_1_0_0, nope: node_1_0_1}
        node_1_0_0['children'] = {buy:  node_1_0_0_0, nope: node_1_0_0_1}
        node_1_0_1['children'] = {nope:  node_1_0_1_0, buy: node_1_0_1_1}
        ...
        node_1_0_1_0['children'] = {}
        node_1_0_1_1['children'] = {price_bump_log: node_1_0_1_1_0}
        node_1_0_0_1_0['children'] = {nope: node_1_0_0_1_0_0}
        ...
        node_1_0_0_1_0_0['children'] = {nope: node_1_0_0_1_0_0_0, buy: node_1_0_0_1_0_0_1}
        node_1_0_0_1_0_0_0['children'] = {}
        node_1_0_0_1_0_0_1['children'] = {price_bump_log_06: node_1_0_0_1_0_0_1_0}
        node_1_0_0_1_0_0_1_0['children'] = {nope: node_1_0_0_1_0_0_1_0_0}
        node_1_0_0_1_0_0_1_0_0['children'] = {nope: node_1_0_0_1_0_0_1_0_0_0}
        node_1_0_0_1_0_0_1_0_0_0['children'] = {}
        return root
